...
void decicion(filter f){
	...
	buf_db.rows_n = 0;
	if(dtype=="string" && filter_name=="Дорівнює")
		string_equals(col_index, value);
	else if(dtype=="string" && filter_name=="Не дорівнює")
		string_not_equals(col_index, value);
	else if(dtype=="string" && filter_name=="Містить")
		string_contains(col_index, value);
	else if(dtype=="string" && filter_name=="Не містить")
		string_not_contains(col_index, value);
	else if(dtype=="string" && filter_name=="Починається на")
		string_starts(col_index, value);
	else if(dtype=="string" && filter_name=="Не починається на")
		string_not_starts(col_index, value);
	else if(dtype=="string" && filter_name=="Закінчується на")
		string_ends(col_index, value);
	else if(dtype=="string" && filter_name=="Не закінчується на")
		string_not_ends(col_index, value);
	else if(dtype=="int" && filter_name=="Дорівнює")
		int_equals(col_index, str_to_int(value));
	else if(dtype=="int" && filter_name=="Не дорівнює")
		int_not_equals(col_index, str_to_int(value));
	else if(dtype=="int" && filter_name=="Більше")
		int_more_than(col_index, str_to_int(value));
	else if(dtype=="int" && filter_name=="Більше-рівне")
		int_more_equals(col_index, str_to_int(value));
	else if(dtype=="int" && filter_name=="Менше")
		int_less_than(col_index, str_to_int(value));
	else if(dtype=="int" && filter_name=="Менше-рівне")
		int_less_equals(col_index, str_to_int(value));
	else if(dtype=="int" && filter_name=="Ділиться на")
		int_divides(col_index, str_to_int(value));
	else if(dtype=="int" && filter_name=="Не ділиться на")
		int_not_divides(col_index, str_to_int(value));
	else if(dtype=="double" && filter_name=="Дорівнює")
		double_equals(col_index, str_to_double(value));
	else if(dtype=="double" && filter_name=="Не дорівнює")
		double_not_equals(col_index, str_to_double(value));
	else if(dtype=="double" && filter_name=="Більше")
		double_more_than(col_index, str_to_double(value));
	else if(dtype=="double" && filter_name=="Більше-рівне")
		double_more_equals(col_index, str_to_double(value));
	else if(dtype=="double" && filter_name=="Менше")
		double_less_than(col_index, str_to_double(value));
	else if(dtype=="double" && filter_name=="Менше-рівне")
